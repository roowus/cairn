...
agent, SQLite audit + NetworkX graph, **28 plugins** (free-first OSINT + agentic
file/shell tools; most free-active by default), live progress output, and an
entity-extraction pivot layer. STIX output, graph/vector DBs, multi-agent, MCP,
and REST are designed behind clean seams — see
